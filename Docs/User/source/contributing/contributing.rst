...
Contributions to the framework are very welcome. Any contribution will have to strictly abide to the :doc:`QA </contributing/qa/qa>` process.

These contributions can be in the form of:
