...
.. code-block:: bash
    ...
    pyhon -m marte2_manager.cli --project_name MARTe2-training-proj --project_path $MARTE_TRAINING_PARENT_DIR -l DEBUG add --cpt_type interfaces --cpt_name MyInterface --cpt_namespace Tutorial # Modify the project name and path if needed
