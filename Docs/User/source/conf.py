...
extlinks = {'vciscorebml0': ('https://vcis-gitlab.f4e.europa.eu/aneto/MARTe2/blob/master/Source/Core/BareMetal/L0Types/%s.h', '%s'),
			...
			'vcisdoxygencl': ('https://vcis-jenkins.f4e.europa.eu/userContent/doxygen/MARTe2/master/html/classMARTe_1_1%s.html', '%s'),
			'vcisdoxygenns': ('https://vcis-jenkins.f4e.europa.eu/userContent/doxygen/MARTe2/master/html/namespaceMARTe_1_1%s.html', '%s'),
			'vcisdoxygenstem': ('https://vcis-jenkins.f4e.europa.eu/userContent/doxygen/MARTe2/master/html/structMARTe_1_1ErrorManagement_1_1%s.html', '%s'),
			'vcisdoxygenclem': ('https://vcis-jenkins.f4e.europa.eu/userContent/doxygen/MARTe2/master/html/classMARTe_1_1ErrorManagement_1_1%s.html', '%s'),
			'vcisdoxygenmccl': ('https://vcis-jenkins.f4e.europa.eu/userContent/doxygen/MARTe2-components/master/html/classMARTe_1_1%s.html', '%s'),
