 ...
 * the class DeltaTSolGTest (public, protected, and private). Be aware that some      
...
TEST(DeltaTSolGTest, TestInitialise) {
    DeltaTSolTest test;
    ASSERT_TRUE(test.TestInitialise());
}

TEST(DeltaTSolGTest, TestSetup) {
    DeltaTSolTest test;
    ASSERT_TRUE(test.TestSetup());
}

TEST(DeltaTSolGTest, TestExecute) {
    DeltaTSolTest test;
