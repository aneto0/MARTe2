 ...
 * @brief Header file for class SystemMonitor                                         
 * @date 17/04/2026                                                                 
 * @author cabrian                                                             
 *                                                                               
 ...
 * @details This header file contains the declaration of the class SystemMonitor      
 * with all of its public, protected and private members. It may also include    
 * definitions for inline methods which need to be visible to the compiler.      
 */                                                                              

#ifndef _TUTORIAL_SYSTEMMONITOR_H_
#define _TUTORIAL_SYSTEMMONITOR_H_
...
class SystemMonitor : public MARTe::DataSourceI {
public:
...
#endif /* _TUTORIAL_SYSTEMMONITOR_H_*/
