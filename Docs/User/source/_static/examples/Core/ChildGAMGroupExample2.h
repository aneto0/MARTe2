/**
 * @file ChildGAMGroupExample2.h
 * @brief Header file for class ChildGAMGroupExample2
 * @date 06/04/2018
 * @author Andre Neto
 *
 ...
 * @details This header file contains the declaration of the class ChildGAMGroupExample2
 * with all of its public, protected and private members. It may also include
 * definitions for inline methods which need to be visible to the compiler.
 */

#ifndef EXAMPLES_CORE_CHILDGAMGROUPEXAMPLE2_H_
#define EXAMPLES_CORE_CHILDGAMGROUPEXAMPLE2_H_
 ...
 *
 * @details This GAM multiplies the input signal the transpose of the matrix shared by the GAMGroup (see SetContext).
 *
 * +GAMExample2 = {
 ...
 * }
 */
class ChildGAMGroupExample2 : public MARTe::GAM {
public:
    CLASS_REGISTER_DECLARATION()
    /**
     * @brief Constructor. NOOP.
     */
    ChildGAMGroupExample2();

    /**
     * @brief Destructor. NOOP.
     */
    virtual ~ChildGAMGroupExample2();

    /**
     * @brief See GAM::SetContext
     * @return true if the parent MARTe::ReferenceT<const GAMGroupSharedInfoExample2> is Valid and if the matrix dimensions are compatible with the input/output signal properties.
     */
...
private:
     ...
     */
    MARTe::Matrix<MARTe::uint32> *transposedModel;
...
#endif /* EXAMPLES_CORE_CHILDGAMGROUPEXAMPLE2_H_ */
