/**
 * @file ConfigurationExample9.cpp
 * @brief Source file for class ConfigurationExample9
 * @date 27/06/2022
 * @author Andre' Neto
 *
 ...
 * the class ConfigurationExample9 (public, protected, and private). Be aware that some
