...
int main(int argc, char **argv) {
    ...
    if (ref1.IsValid()) {
        ...
        //Write a valid configuration.
        {
            ...
            REPORT_ERROR_STATIC(ErrorManagement::Information, "Going to load the following configuration\n%s", cdb);
        ...
        //Write an invalid configuration
        {
            ...
            if (!ref1->Initialise(cdb)) {
                REPORT_ERROR_STATIC(ErrorManagement::Information, "As expected failed to configure instance of %s", ref1->GetName());
            }
        }
    }
