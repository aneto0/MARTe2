/**
 * @file PlainLoggerServiceGTest.cpp
 * @brief Source file for class PlainLoggerServiceGTest
 * @date 02/07/2024
 ...
 * the class PlainLoggerServiceGTest (public, protected, and private). Be aware that some 
