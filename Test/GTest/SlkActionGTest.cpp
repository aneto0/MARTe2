...
TEST(SlkSlkActionGTest,TestParseErrors_NotLValue_variable_1) {
    SlkActionTest slkActionTest;
    const char8* configString="block={\n"
            "                        var{10}\n"
            "                 }";
    ASSERT_TRUE(slkActionTest.TestParseErrors(configString));
}


TEST(SlkSlkActionGTest,TestParseErrors_NotLValue_variable_2) {
    SlkActionTest slkActionTest;
    const char8* configString="block={\n"
            "                    //this is ok\n"
            "                        var=2\n"
...
TEST(SlkSlkActionGTest,TestParseErrors_NotLValue_Block) {
    SlkActionTest slkActionTest;
...
TEST(SlkSlkActionGTest,TestParseErrors_empty_vector) {
    SlkActionTest slkActionTest;
    const char8* configString="block1={\n"
            "                        var=1\n"
            "                        block2={\n"
...
TEST(SlkSlkActionGTest,TestParseErrors_unterminated_vector) {
    SlkActionTest slkActionTest;
    const char8* configString="block1={\n"
            "                        var=1\n"
            "                        block2={\n"
...
TEST(SlkSlkActionGTest,TestParseErrors_mixTypes_vector) {
    SlkActionTest slkActionTest;
    const char8* configString="block1={\n"
            "                        var=1\n"
            "                        block2={\n"
...
TEST(SlkSlkActionGTest,TestParseErrors_badCloseTerminal_vector) {
    SlkActionTest slkActionTest;
    const char8* configString="block1={\n"
            "                        var=1\n"
            "                        block2={\n"
...
TEST(SlkSlkActionGTest,TestParseErrors_empty_matrix) {
    SlkActionTest slkActionTest;
    const char8* configString="block1={\n"
            "                        var=1\n"
            "                        block2={\n"
...
TEST(SlkSlkActionGTest,TestParseErrors_badVectorOpenTerminal_matrix) {
    SlkActionTest slkActionTest;
    const char8* configString="block1={\n"
            "                        var=1\n"
            "                        block2={\n"
...
TEST(SlkSlkActionGTest,TestParseErrors_noVectorOpenTerminal_matrix) {
    SlkActionTest slkActionTest;
    const char8* configString="block1={\n"
            "                        var=1\n"
            "                        block2={\n"
...
TEST(SlkSlkActionGTest,TestParseErrors_badVectorCloseTerminal_matrix) {
    SlkActionTest slkActionTest;
    const char8* configString="block1={\n"
            "                        var=1\n"
            "                        block2={\n"
...
TEST(SlkSlkActionGTest,TestParseErrors_noVectorCloseTerminal_matrix) {
    SlkActionTest slkActionTest;
    const char8* configString="block1={\n"
            "                        var=1\n"
            "                        block2={\n"
...
TEST(SlkSlkActionGTest,TestParseErrors_mixTypes_matrix) {
    SlkActionTest slkActionTest;
    const char8* configString="block1={\n"
            "                        var=1\n"
            "                        block2={\n"
...
TEST(SlkSlkActionGTest,TestParseErrors_badFormat_matrix) {
    SlkActionTest slkActionTest;
    const char8* configString="block1={\n"
            "                        var=1\n"
            "                        block2={\n"
...
TEST(SlkSlkActionGTest,TestParseErrors_typeCast_terminal_1) {
    SlkActionTest slkActionTest;
    const char8* configString="block1={\n"
            "                        var=1\n"
            "                        block2={\n"
...
TEST(SlkSlkActionGTest,TestParseErrors_typeCast_terminal_2) {
    SlkActionTest slkActionTest;
    const char8* configString="block1={\n"
            "                        var=1\n"
            "                        block2={\n"
...
TEST(SlkSlkActionGTest,TestParseErrors_Too_many_CloseBlockTerminal_1) {
    SlkActionTest slkActionTest;
    const char8* configString="block1={\n"
            "                        var=1\n"
            "                        block2={\n"
...
TEST(SlkSlkActionGTest,TestParseErrors_Too_many_CloseBlockTerminal_2) {
    SlkActionTest slkActionTest;
    const char8* configString="block1={\n"
            "                        var=1\n"
            "                        block2={\n"
...
TEST(SlkSlkActionGTest,TestParseErrors_Too_many_CloseBlockTerminal_3) {
    SlkActionTest slkActionTest;
    const char8* configString="block1={\n"
            "                        var=1\n"
            "                        block2={\n"
...
TEST(SlkSlkActionGTest,TestParseErrors_Too_many_OpenBlockTerminal) {
    SlkActionTest slkActionTest;
    const char8* configString="block1={\n"
            "                        var=1\n"
            "                        block2={{\n"
...
TEST(SlkSlkActionGTest,TestParseErrors_Unexpected_EOF) {
    SlkActionTest slkActionTest;
    const char8* configString="block1={\n"
            "                        var=1\n"
            "                        block2={\n"
...
TEST(SlkSlkActionGTest,TestStandardCast) {
    SlkActionTest slkActionTest;
    ASSERT_TRUE(slkActionTest.TestStandardCast());
}



TEST(SlkActionGTest,TestTypeCast_Scalar_int8) {
    SlkActionTest slkActionTest;
    ...
    ASSERT_TRUE(slkActionTest.TestTypeCast_Scalar(table));
}


TEST(SlkActionGTest,TestTypeCast_Scalar_uint8) {
    SlkActionTest slkActionTest;
...
TEST(SlkActionGTest,TestTypeCast_Scalar_int16) {
    SlkActionTest slkActionTest;
...
TEST(SlkActionGTest,TestTypeCast_Scalar_uint16) {
    SlkActionTest slkActionTest;
...
TEST(SlkActionGTest,TestTypeCast_Scalar_int32) {
    SlkActionTest slkActionTest;
...
TEST(SlkActionGTest,TestTypeCast_Scalar_uint32) {
    SlkActionTest slkActionTest;
...
TEST(SlkActionGTest,TestTypeCast_Scalar_int64) {
    SlkActionTest slkActionTest;
...
TEST(SlkActionGTest,TestTypeCast_Scalar_uint64) {
    SlkActionTest slkActionTest;
...
TEST(SlkActionGTest,TestTypeCast_Scalar_float32) {
    SlkActionTest slkActionTest;
...
TEST(SlkActionGTest,TestTypeCast_Scalar_float64) {
    SlkActionTest slkActionTest;
...
TEST(SlkActionGTest,TestTypeCast_Vector_int8) {
    SlkActionTest slkActionTest;
    ...
    ASSERT_TRUE(slkActionTest.TestTypeCast_Vector(table));
}


TEST(SlkActionGTest,TestTypeCast_Vector_uint8) {
    SlkActionTest slkActionTest;
...
TEST(SlkActionGTest,TestTypeCast_Vector_int16) {
    SlkActionTest slkActionTest;
...
TEST(SlkActionGTest,TestTypeCast_Vector_uint16) {
    SlkActionTest slkActionTest;
...
TEST(SlkActionGTest,TestTypeCast_Vector_int32) {
    SlkActionTest slkActionTest;
...
TEST(SlkActionGTest,TestTypeCast_Vector_uint32) {
    SlkActionTest slkActionTest;
...
TEST(SlkActionGTest,TestTypeCast_Vector_int64) {
    SlkActionTest slkActionTest;
...
TEST(SlkActionGTest,TestTypeCast_Vector_uint64) {
    SlkActionTest slkActionTest;
...
TEST(SlkActionGTest,TestTypeCast_Vector_float32) {
    SlkActionTest slkActionTest;
...
TEST(SlkActionGTest,TestTypeCast_Vector_float64) {
    SlkActionTest slkActionTest;
...
TEST(SlkActionGTest,TestTypeCast_Matrix_int8) {
    SlkActionTest slkActionTest;
    ...
    ASSERT_TRUE(slkActionTest.TestTypeCast_Matrix(table));
}


TEST(SlkActionGTest,TestTypeCast_Matrix_uint8) {
    SlkActionTest slkActionTest;
...
TEST(SlkActionGTest,TestTypeCast_Matrix_int16) {
    SlkActionTest slkActionTest;
...
TEST(SlkActionGTest,TestTypeCast_Matrix_uint16) {
    SlkActionTest slkActionTest;
...
TEST(SlkActionGTest,TestTypeCast_Matrix_int32) {
    SlkActionTest slkActionTest;
...
TEST(SlkActionGTest,TestTypeCast_Matrix_uint32) {
    SlkActionTest slkActionTest;
...
TEST(SlkActionGTest,TestTypeCast_Matrix_int64) {
    SlkActionTest slkActionTest;
...
TEST(SlkActionGTest,TestTypeCast_Matrix_uint64) {
    SlkActionTest slkActionTest;
...
TEST(SlkActionGTest,TestTypeCast_Matrix_float32) {
    SlkActionTest slkActionTest;
...
TEST(SlkActionGTest,TestTypeCast_Matrix_float64) {
    SlkActionTest slkActionTest;
...
TEST(SlkActionGTest,TestExistentFile) {
    SlkActionTest slkActionTest;
    ASSERT_TRUE(slkActionTest.TestExistentFile());
}
