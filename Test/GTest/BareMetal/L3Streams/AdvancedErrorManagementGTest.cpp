/**
 * @file AdvancedErrorManagementGTest.cpp
 * @brief Source file for class AdvancedErrorManagementGTest
 * @date 12/03/2017
 * @author Andre Neto
 *
 ...
 * the class AdvancedErrorManagementGTest (public, protected, and private). Be aware that some 
