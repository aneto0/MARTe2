/**
 * @file MemoryMapMultiBufferOutputBrokerGTest.cpp
 * @brief Source file for class MemoryMapMultiBufferOutputBrokerGTest
 * @date 16/04/2018
 ...
 * the class MemoryMapMultiBufferOutputBrokerGTest (public, protected, and private). Be aware that some
