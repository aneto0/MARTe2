/**
 * @file HttpDataExportIGTest.cpp
 * @brief Source file for class HttpDataExportIGTest
 * @date 15/03/2019
 * @author Andre Neto
 *
 ...
 * the class HttpDataExportIGTest (public, protected, and private). Be aware that some
