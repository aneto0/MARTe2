/**
 * @file StreamIGTest.cpp
 * @brief Source file for class StreamIGTest
 * @date 07/08/2015
 ...
 * the class StreamIGTest (public, protected, and private). Be aware that some
...
class StreamIGTest: public ::testing::Test {
protected:
    virtual void SetUp() {
...
TEST_F(StreamIGTest,TestDefaultConstructor) {
    StreamITest streamtest;
    ASSERT_TRUE(streamtest.TestDefaultConstructor());
}

TEST_F(StreamIGTest,TestAnyType) {
    StreamITest streamtest;
...
TEST_F(StreamIGTest,TestGetToken_TableTerminators_BufferSize_2) {
    StreamITest streamtest;
    ASSERT_TRUE(streamtest.TestGetToken(2, &TokenTestTableTerminators[0]));
}

TEST_F(StreamIGTest,TestGetToken_TableTerminators_BufferSize_8) {
    StreamITest streamtest;
    ASSERT_TRUE(streamtest.TestGetToken(8, &TokenTestTableTerminators[0]));
}

TEST_F(StreamIGTest,TestGetToken_TableTerminators_BufferSize_64) {
    StreamITest streamtest;
    ASSERT_TRUE(streamtest.TestGetToken(64, &TokenTestTableTerminators[0]));
}

TEST_F(StreamIGTest,TestGetToken_TableTerminators_BufferSize_128) {
    StreamITest streamtest;
    ASSERT_TRUE(streamtest.TestGetToken(128, &TokenTestTableTerminators[0]));
}

TEST_F(StreamIGTest,TestGetToken_TableTerminators_BufferSize_1024) {
    StreamITest streamtest;
    ASSERT_TRUE(streamtest.TestGetToken(1024, &TokenTestTableTerminators[0]));
}

TEST_F(StreamIGTest,TestGetToken_TableSkipCharacters_BufferSize_1) {
    StreamITest streamtest;
    ASSERT_TRUE(streamtest.TestGetToken(1, &TokenTestTableSkipCharacters[0]));
}

TEST_F(StreamIGTest,TestGetToken_TableSkipCharacters_BufferSize_2) {
    StreamITest streamtest;
    ASSERT_TRUE(streamtest.TestGetToken(2, &TokenTestTableSkipCharacters[0]));
}

TEST_F(StreamIGTest,TestGetToken_TableSkipCharacters_BufferSize_8) {
    StreamITest streamtest;
    ASSERT_TRUE(streamtest.TestGetToken(8, &TokenTestTableSkipCharacters[0]));
}

TEST_F(StreamIGTest,TestGetToken_TableSkipCharacters_BufferSize_64) {
    StreamITest streamtest;
    ASSERT_TRUE(streamtest.TestGetToken(64, &TokenTestTableSkipCharacters[0]));
}

TEST_F(StreamIGTest,TestGetToken_TableSkipCharacters_BufferSize_128) {
    StreamITest streamtest;
    ASSERT_TRUE(streamtest.TestGetToken(128, &TokenTestTableSkipCharacters[0]));
}

TEST_F(StreamIGTest,TestGetToken_TableSkipCharacters_BufferSize_1024) {
    StreamITest streamtest;
    ASSERT_TRUE(streamtest.TestGetToken(1024, &TokenTestTableSkipCharacters[0]));
}

TEST_F(StreamIGTest,TestGetToken_Stream_TableTerminators_BufferSize_1) {
    StreamITest streamtest;
    ASSERT_TRUE(streamtest.TestGetToken_Stream(1, &TokenTestTableTerminators[0]));
}

TEST_F(StreamIGTest,TestGetToken_Stream_TableTerminators_BufferSize_2) {
    StreamITest streamtest;
    ASSERT_TRUE(streamtest.TestGetToken_Stream(2, &TokenTestTableTerminators[0]));
}

TEST_F(StreamIGTest,TestGetToken_Stream_TableTerminators_BufferSize_8) {
    StreamITest streamtest;
    ASSERT_TRUE(streamtest.TestGetToken_Stream(8, &TokenTestTableTerminators[0]));
}

TEST_F(StreamIGTest,TestGetToken_Stream_TableTerminators_BufferSize_64) {
    StreamITest streamtest;
    ASSERT_TRUE(streamtest.TestGetToken_Stream(64, &TokenTestTableTerminators[0]));
}

TEST_F(StreamIGTest,TestGetToken_Stream_TableTerminators_BufferSize_128) {
    StreamITest streamtest;
    ASSERT_TRUE(streamtest.TestGetToken_Stream(128, &TokenTestTableTerminators[0]));
}

TEST_F(StreamIGTest,TestGetToken_Stream_TableTerminators_BufferSize_1024) {
    StreamITest streamtest;
    ASSERT_TRUE(streamtest.TestGetToken_Stream(1024, &TokenTestTableTerminators[0]));
}

TEST_F(StreamIGTest,TestGetToken_Stream_TableSkipCharacters_BufferSize_1) {
    StreamITest streamtest;
    ASSERT_TRUE(streamtest.TestGetToken_Stream(1, &TokenTestTableSkipCharacters[0]));
}

TEST_F(StreamIGTest,TestGetToken_Stream_TableSkipCharacters_BufferSize_2) {
    StreamITest streamtest;
    ASSERT_TRUE(streamtest.TestGetToken_Stream(2, &TokenTestTableSkipCharacters[0]));
}

TEST_F(StreamIGTest,TestGetToken_Stream_TableSkipCharacters_BufferSize_8) {
    StreamITest streamtest;
    ASSERT_TRUE(streamtest.TestGetToken_Stream(8, &TokenTestTableSkipCharacters[0]));
}

TEST_F(StreamIGTest,TestGetToken_Stream_TableSkipCharacters_BufferSize_64) {
    StreamITest streamtest;
    ASSERT_TRUE(streamtest.TestGetToken_Stream(64, &TokenTestTableSkipCharacters[0]));
}

TEST_F(StreamIGTest,TestGetToken_Stream_TableSkipCharacters_BufferSize_128) {
    StreamITest streamtest;
    ASSERT_TRUE(streamtest.TestGetToken_Stream(128, &TokenTestTableSkipCharacters[0]));
}

TEST_F(StreamIGTest,TestGetToken_Stream_TableSkipCharacters_BufferSize_1024) {
    StreamITest streamtest;
    ASSERT_TRUE(streamtest.TestGetToken_Stream(1024, &TokenTestTableSkipCharacters[0]));
}

TEST_F(StreamIGTest,TestSkipTokens_BufferSize_1) {
    StreamITest streamtest;
    ASSERT_TRUE(streamtest.TestSkipTokens(1, &SkipTokensTestTable[0]));
}

TEST_F(StreamIGTest,TestSkipTokens_BufferSize_2) {
    StreamITest streamtest;
    ASSERT_TRUE(streamtest.TestSkipTokens(2, &SkipTokensTestTable[0]));
}

TEST_F(StreamIGTest,TestSkipTokens_BufferSize_8) {
    StreamITest streamtest;
    ASSERT_TRUE(streamtest.TestSkipTokens(8, &SkipTokensTestTable[0]));
}

TEST_F(StreamIGTest,TestSkipTokens_BufferSize_64) {
    StreamITest streamtest;
    ASSERT_TRUE(streamtest.TestSkipTokens(64, &SkipTokensTestTable[0]));
}

TEST_F(StreamIGTest,TestSkipTokens_BufferSize_128) {
    StreamITest streamtest;
    ASSERT_TRUE(streamtest.TestSkipTokens(128, &SkipTokensTestTable[0]));
}

TEST_F(StreamIGTest,TestSkipTokens_BufferSize_1024) {
    StreamITest streamtest;
    ASSERT_TRUE(streamtest.TestSkipTokens(1024, &SkipTokensTestTable[0]));
}

TEST_F(StreamIGTest,TestGetLine_NoSkipCharacter_BufferSize_1) {
    StreamITest streamtest;
    ASSERT_TRUE(streamtest.TestGetLine(1, false));
}

TEST_F(StreamIGTest,TestGetLine_NoSkipCharacter_BufferSize_2) {
    StreamITest streamtest;
    ASSERT_TRUE(streamtest.TestGetLine(2, false));
}

TEST_F(StreamIGTest,TestGetLine_NoSkipCharacter_BufferSize_8) {
    StreamITest streamtest;
    ASSERT_TRUE(streamtest.TestGetLine(8, false));
}

TEST_F(StreamIGTest,TestGetLine_NoSkipCharacter_BufferSize_64) {
    StreamITest streamtest;
    ASSERT_TRUE(streamtest.TestGetLine(64, false));
}

TEST_F(StreamIGTest,TestGetLine_NoSkipCharacter_BufferSize_128) {
    StreamITest streamtest;
    ASSERT_TRUE(streamtest.TestGetLine(128, false));
}

TEST_F(StreamIGTest,TestGetLine_NoSkipCharacter_BufferSize_1024) {
    StreamITest streamtest;
    ASSERT_TRUE(streamtest.TestGetLine(1024, false));
}

TEST_F(StreamIGTest,TestGetLine_SkipCharacter_BufferSize_1) {
    StreamITest streamtest;
    ASSERT_TRUE(streamtest.TestGetLine(1, true));
}

TEST_F(StreamIGTest,TestGetLine_SkipCharacter_BufferSize_2) {
    StreamITest streamtest;
    ASSERT_TRUE(streamtest.TestGetLine(2, true));
}

TEST_F(StreamIGTest,TestGetLine_SkipCharacter_BufferSize_8) {
    StreamITest streamtest;
    ASSERT_TRUE(streamtest.TestGetLine(8, true));
}

TEST_F(StreamIGTest,TestGetLine_SkipCharacter_BufferSize_64) {
    StreamITest streamtest;
    ASSERT_TRUE(streamtest.TestGetLine(64, true));
}

TEST_F(StreamIGTest,TestGetLine_SkipCharacter_BufferSize_128) {
    StreamITest streamtest;
    ASSERT_TRUE(streamtest.TestGetLine(128, true));
}

TEST_F(StreamIGTest,TestGetLine_SkipCharacter_BufferSize_1024) {
    StreamITest streamtest;
    ASSERT_TRUE(streamtest.TestGetLine(1024, true));
}

TEST_F(StreamIGTest,TestGetLine_Stream_NoSkipCharacter_BufferSize_1) {
    StreamITest streamtest;
    ASSERT_TRUE(streamtest.TestGetLine_Stream(1, false));
}

TEST_F(StreamIGTest,TestGetLine_Stream_NoSkipCharacter_BufferSize_2) {
    StreamITest streamtest;
    ASSERT_TRUE(streamtest.TestGetLine_Stream(2, false));
}

TEST_F(StreamIGTest,TestGetLine_Stream_NoSkipCharacter_BufferSize_8) {
    StreamITest streamtest;
    ASSERT_TRUE(streamtest.TestGetLine_Stream(8, false));
}

TEST_F(StreamIGTest,TestGetLine_Stream_NoSkipCharacter_BufferSize_64) {
    StreamITest streamtest;
    ASSERT_TRUE(streamtest.TestGetLine_Stream(64, false));
}

TEST_F(StreamIGTest,TestGetLine_Stream_NoSkipCharacter_BufferSize_128) {
    StreamITest streamtest;
    ASSERT_TRUE(streamtest.TestGetLine_Stream(128, false));
}

TEST_F(StreamIGTest,TestGetLine_Stream_NoSkipCharacter_BufferSize_1024) {
    StreamITest streamtest;
    ASSERT_TRUE(streamtest.TestGetLine_Stream(1024, false));
}

TEST_F(StreamIGTest,TestGetLine_Stream_SkipCharacter_BufferSize_1) {
    StreamITest streamtest;
    ASSERT_TRUE(streamtest.TestGetLine_Stream(1, true));
}

TEST_F(StreamIGTest,TestGetLine_Stream_SkipCharacter_BufferSize_2) {
    StreamITest streamtest;
    ASSERT_TRUE(streamtest.TestGetLine_Stream(2, true));
}

TEST_F(StreamIGTest,TestGetLine_Stream_SkipCharacter_BufferSize_8) {
    StreamITest streamtest;
    ASSERT_TRUE(streamtest.TestGetLine_Stream(8, true));
}

TEST_F(StreamIGTest,TestGetLine_Stream_SkipCharacter_BufferSize_64) {
    StreamITest streamtest;
    ASSERT_TRUE(streamtest.TestGetLine_Stream(64, true));
}

TEST_F(StreamIGTest,TestGetLine_Stream_SkipCharacter_BufferSize_128) {
    StreamITest streamtest;
    ASSERT_TRUE(streamtest.TestGetLine_Stream(128, true));
}

TEST_F(StreamIGTest,TestGetLine_Stream_SkipCharacter_BufferSize_1024) {
    StreamITest streamtest;
    ASSERT_TRUE(streamtest.TestGetLine_Stream(1024, true));
}

TEST_F(StreamIGTest,TestCopy_BufferSize_1) {
    StreamITest streamtest;
    ASSERT_TRUE(streamtest.TestCopy(1));
}

TEST_F(StreamIGTest,TestCopy_BufferSize_2) {
    StreamITest streamtest;
    ASSERT_TRUE(streamtest.TestCopy(2));
}

TEST_F(StreamIGTest,TestCopy_BufferSize_8) {
    StreamITest streamtest;
    ASSERT_TRUE(streamtest.TestCopy(8));
}

TEST_F(StreamIGTest,TestCopy_BufferSize_64) {
    StreamITest streamtest;
    ASSERT_TRUE(streamtest.TestCopy(64));
}

TEST_F(StreamIGTest,TestCopy_BufferSize_128) {
    StreamITest streamtest;
    ASSERT_TRUE(streamtest.TestCopy(128));
}

TEST_F(StreamIGTest,TestCopy_BufferSize_1024) {
    StreamITest streamtest;
    ASSERT_TRUE(streamtest.TestCopy(1024));
}

TEST_F(StreamIGTest,TestCopy_Stream_BufferSize_1) {
    StreamITest streamtest;
    ASSERT_TRUE(streamtest.TestCopy_Stream(1));
}

TEST_F(StreamIGTest,TestCopy_Stream_BufferSize_2) {
    StreamITest streamtest;
    ASSERT_TRUE(streamtest.TestCopy_Stream(2));
}

TEST_F(StreamIGTest,TestCopy_Stream_BufferSize_8) {
    StreamITest streamtest;
    ASSERT_TRUE(streamtest.TestCopy_Stream(8));
}

TEST_F(StreamIGTest,TestCopy_Stream_BufferSize_64) {
    StreamITest streamtest;
    ASSERT_TRUE(streamtest.TestCopy_Stream(64));
}

TEST_F(StreamIGTest,TestCopy_Stream_BufferSize_128) {
    StreamITest streamtest;
    ASSERT_TRUE(streamtest.TestCopy_Stream(128));
}

TEST_F(StreamIGTest,TestCopy_Stream_BufferSize_1024) {
    StreamITest streamtest;
