/**
 * @file TCPSocketTest.h
 * @brief Header file for class TCPSocketTest
 * @date 16/11/2016
 * @author Andre Neto
 *
 ...
 * @details This header file contains the declaration of the class TCPSocketTest
 * with all of its public, protected and private members. It may also include
 * definitions for inline methods which need to be visible to the compiler.
 */

#ifndef TEST_CORE_FILESYSTEM_L3STREAMS_TCPSOCKETTEST_H_
#define TEST_CORE_FILESYSTEM_L3STREAMS_TCPSOCKETTEST_H_
...
/*---------------------------------------------------------------------------*/
/**
 * @brief Tests the TCPSocket public methods.
 */
 class TCPSocketTest {
public:
     /**
...
#endif /* TEST_CORE_FILESYSTEM_L3STREAMS_TCPSOCKETTEST_H_ */
