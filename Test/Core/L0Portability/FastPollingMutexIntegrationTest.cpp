/**
 * @file FastPollingMutexIntegrationTest.cpp
 * @brief Source file for class FastPollingMutexIntegrationTest
 * @date 26/06/2015
 ...
 * the class FastPollingMutexIntegrationTest (public, protected, and private). Be aware that some 
...
FastPollingMutexIntegrationTest::FastPollingMutexIntegrationTest() {
    sharedVariable = 0;
    exitCondition = 0;
...
bool MutexLock(FastPollingMutexIntegrationTest &fastMutexTest,
               int32 index) {

    if (!fastMutexTest.fastMutexSem[index - 1].FastLock(fastMutexTest.timeout)) {
        return False;
    }
...
bool MutexUnLock(FastPollingMutexIntegrationTest &fastMutexTest,
                 int32 index) {

    fastMutexTest.fastMutexSem[index - 1].FastUnLock();
...
void Increment(FastPollingMutexIntegrationTest &fastMutexTest) {
...
void Decrement(FastPollingMutexIntegrationTest &fastMutexTest) {
    //Lock the Mutex 2
    if (!MutexLock(fastMutexTest, 2)) {
        fastMutexTest.exitCondition++;
        return;
...
void InfiniteLoop(FastPollingMutexIntegrationTest &fastMutexTest) {
...
bool FastPollingMutexIntegrationTest::TestSync(int32 nOfThreads) {
    sharedVariable = 0;
    timeout = TTInfiniteWait;
    exitCondition = 0;
    expired = False;
...
bool FastPollingMutexIntegrationTest::TestSyncTimeout(TimeoutType timeout,
                                                      int32 nOfThreads) {
    sharedVariable = 0;
    exitCondition = 0;
    ...
    TID tidFirst = Threads::BeginThread((ThreadFunctionType) InfiniteLoop, this);
    uint32 j = 0;
...
bool FastPollingMutexIntegrationTest::FakeLock() {
    sharedVariable = 0;
    exitCondition = 0;
    timeout = TTInfiniteWait;
    expired = False;
...
bool FastPollingMutexIntegrationTest::DeadLock() {
    sharedVariable = 0;
    exitCondition = 0;
    timeout = TTInfiniteWait;
    expired = False;
...
bool FastPollingMutexIntegrationTest::KillWithLock() {
