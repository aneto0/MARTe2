/**
 * @file ThreadsIntegrationTest.h
 * @brief Header file for class ThreadsIntegrationTest
 * @date 25/06/2015
 ...
 * @details This header file contains the declaration of the class ThreadsIntegrationTest
 * with all of its public, protected and private members. It may also include
 * definitions for inline methods which need to be visible to the compiler.
 */

#ifndef THREADSINTEGRATIONTEST_H_
#define 		THREADSINTEGRATIONTEST_H_
...
#endif /* THREADSINTEGRATIONTEST_H_ */
