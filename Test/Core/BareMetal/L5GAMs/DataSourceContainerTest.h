/**
 * @file DataSourceContainerTest.h
 * @brief Header file for class DataSourceContainerTest
 * @date 15/04/2016
 ...
 * @details This header file contains the declaration of the class DataSourceContainerTest
 * with all of its public, protected and private members. It may also include
 * definitions for inline methods which need to be visible to the compiler.
 */

#ifndef DATASOURCECONTAINERTEST_H_
#define DATASOURCECONTAINERTEST_H_
...
public:
    ...
    /**
     * @brief Tests if the function fails trying to generate a new definition node if the data source does not exist.
     */
    bool TestAddDataDefinitionFalse_InvalidPath();
...
#endif /* DATASOURCECONTAINERTEST_H_ */
