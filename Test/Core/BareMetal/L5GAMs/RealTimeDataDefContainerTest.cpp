/**
 * @file RealTimeDataDefContainerTest.cpp
 * @brief Source file for class RealTimeDataDefContainerTest
 * @date 04/03/2016
 ...
 * the class RealTimeDataDefContainerTest (public, protected, and private). Be aware that some 
...
bool RealTimeDataDefContainerTest::TestConstructor() {
    RealTimeDataDefContainer def;
    return (!def.IsInput()) && (!def.IsOutput());
}

bool RealTimeDataDefContainerTest::TestInitialise() {
    RealTimeDataDefContainer def;
...
bool RealTimeDataDefContainerTest::TestMergeWithLocal() {

    ConfigurationDatabase localData;

    localData.Write("Class", "RealTimeGenericDataDefContainer");
    ...
    cdb.Write("Class", "RealTimeGenericDataDefContainer");
    ...
    ReferenceT<RealTimeDataDefContainer> test = ReferenceT<RealTimeDataDefContainer>(GlobalObjectsDatabase::Instance()->GetStandardHeap());
    test->SetName("Inputs");
...
bool RealTimeDataDefContainerTest::TestMergeWithLocal_AddDefinition() {
    ConfigurationDatabase localData;
...
bool RealTimeDataDefContainerTest::TestMergeWithLocalFalse_GlobalFinal() {
...
bool RealTimeDataDefContainerTest::TestMergeWithLocal_AddInput() {
    ConfigurationDatabase localData;
...
bool RealTimeDataDefContainerTest::TestMergeWithLocal_AddOutput() {
    ConfigurationDatabase localData;
...
bool RealTimeDataDefContainerTest::TestVerify() {
    ConfigurationDatabase localData;
...
bool RealTimeDataDefContainerTest::TestVerify_DefInvalid() {
    ConfigurationDatabase localData;
...
bool RealTimeDataDefContainerTest::TestIsInput() {
    RealTimeDataDefContainer def;
    if (def.IsInput()) {
        return false;
    }
...
bool RealTimeDataDefContainerTest::TestIsOutput() {
    RealTimeDataDefContainer def;
    if (def.IsOutput()) {
        return false;
    }
...
bool RealTimeDataDefContainerTest::TestToStructuredData(){
