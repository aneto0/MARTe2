/**
 * @file DataSourceSignalRecordTest.h
 * @brief Header file for class DataSourceSignalRecordTest
 * @date 13/04/2016
 ...
 * @details This header file contains the declaration of the class DataSourceSignalRecordTest
 * with all of its public, protected and private members. It may also include
 * definitions for inline methods which need to be visible to the compiler.
 */

#ifndef DATASOURCESIGNALRECORDTEST_H_
#define DATASOURCESIGNALRECORDTEST_H_
...
/**
 * @brief Tests all the DataSourceSignalRecord functions.
 */
class DataSourceSignalRecordTest {
public:
...
#endif /* DATASOURCESIGNALRECORDTEST_H_ */
