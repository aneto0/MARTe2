 ...
 * @brief Header file for class DataSourceTest
 * @date 15/04/2016
 ...
 * @details This header file contains the declaration of the class DataSourceTest
...
/*---------------------------------------------------------------------------*/
#include "../../../../Source/Core/BareMetal/L5GAMs/DataSourceI.h"
/*---------------------------------------------------------------------------*/
/*                           Class declaration                               */
/*---------------------------------------------------------------------------*/
...
/**
 * @brief Tests all the DataSource functions.
 */
