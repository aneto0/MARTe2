...
CLASS_MEMBER_REGISTER(IntrospectableIntegerObject,member);


CLASS_REGISTER(IntrospectableObjectWith2Members, "1.0")
CLASS_MEMBER_REGISTER(IntrospectableObjectWith2Members, member1);
CLASS_MEMBER_REGISTER(IntrospectableObjectWith2Members, member2);


CLASS_REGISTER(IntrospectableObjectWith3Members, "1.0")
CLASS_MEMBER_REGISTER(IntrospectableObjectWith3Members, member1);
CLASS_MEMBER_REGISTER(IntrospectableObjectWith3Members, member2);
CLASS_MEMBER_REGISTER(IntrospectableObjectWith3Members, member3);
