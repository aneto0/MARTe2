...
#if 0
bool StructuredDataIHelperTest::TestCreateAbsolute_ValidPath() {
    ConfigurationDatabase cdb;
...
bool StructuredDataIHelperTest::TestCreateAbsolute_InvalidPath() {
    ConfigurationDatabase cdb;
...
bool StructuredDataIHelperTest::TestCreateRelative_ValidPath() {
    ConfigurationDatabase cdb;
...
bool StructuredDataIHelperTest::TestCreateRelative_InvalidPath() {
    ConfigurationDatabase cdb;
...
bool StructuredDataIHelperTest::TestMoveToAncestor_ValidNumberOfGenerations() {
    ConfigurationDatabase cdb;
    bool ok = cdb.MoveToRoot();
...
bool StructuredDataIHelperTest::TestMoveToAncestor_InvalidNumberOfGenerations() {
    ConfigurationDatabase cdb;
    bool ok = cdb.MoveToRoot();
    ok &= cdb.CreateAbsolute("A.B.C.D.E");
    ok &= cdb.CreateAbsolute("A.B.C.F.G");
...
bool StructuredDataIHelperTest::TestMoveAbsolute_ValidPaths() {
    ConfigurationDatabase cdb;
    bool ok = cdb.MoveToRoot();
    ok &= cdb.CreateAbsolute("A.B.C.D.E");
...
bool StructuredDataIHelperTest::TestMoveAbsolute_InvalidPaths() {
    ConfigurationDatabase cdb;
    bool ok = cdb.MoveToRoot();
    ok &= cdb.CreateAbsolute("A.B.C.D.E");
    ok &= cdb.CreateAbsolute("A.C.D.E");
...
bool StructuredDataIHelperTest::TestMoveRelative_ValidPaths() {
    ConfigurationDatabase cdb;
    bool ok = cdb.MoveToRoot();
    ok &= cdb.CreateAbsolute("A.B.C.D.E");
    ok &= cdb.CreateAbsolute("A.C.D.E");
...
bool StructuredDataIHelperTest::TestMoveRelative_InvalidPaths() {
    ConfigurationDatabase cdb;
    bool ok = cdb.MoveToRoot();
    ok &= cdb.CreateAbsolute("A.B.C.D.E");
    ok &= cdb.CreateAbsolute("A.C.D.E");
...
bool StructuredDataIHelperTest::TestRead_Invalid() {
    ConfigurationDatabase cdb;
    uint32 readValue = 0;
...
bool StructuredDataIHelperTest::TestRead_StructuredData() {
...
bool StructuredDataIHelperTest::TestRead_Object() {
    ConfigurationDatabase source;
...
bool StructuredDataIHelperTest::TestAddToCurrentNode_InvalidReference() {
    ConfigurationDatabase cdb;
    ReferenceT<ReferenceContainer> obj;
    return !cdb.AddToCurrentNode(obj);
}

bool StructuredDataIHelperTest::TestWrite_Overwrite() {
    ConfigurationDatabase cdb;
...
bool StructuredDataIHelperTest::TestWrite_Invalid() {
    ConfigurationDatabase cdb;
    uint32 writeValue = 5;
...
bool StructuredDataIHelperTest::TestWrite_StructuredData() {
    ConfigurationDatabase source;
    source.CreateAbsolute("A.B.C");
    int32 x = 1;
    source.Write("x", x);
...
bool StructuredDataIHelperTest::TestWrite_Object() {
...
bool StructuredDataIHelperTest::TestGetType_Invalid() {
    ConfigurationDatabase cdb;
...
bool StructuredDataIHelperTest::TestLock() {
    ConfigurationDatabase cdb;
    return cdb.Lock(TTInfiniteWait);
}

bool StructuredDataIHelperTest::TestUnlock() {
    ConfigurationDatabase cdb;
...
bool StructuredDataIHelperTest::TestInitialise() {
...
bool StructuredDataIHelperTest::TestCleanUp() {
    ConfigurationDatabase cdb;
    bool ok = cdb.CreateAbsolute("A");
    ok = cdb.MoveToRoot();
    ok &= cdb.Write("AAA", 5);
...
bool StructuredDataIHelperTest::TestGetCurrentNode() {
    ConfigurationDatabase cdb;
    bool ok = cdb.CreateAbsolute("A");
    ok = cdb.MoveToRoot();
    ok &= cdb.MoveAbsolute("A");
...
bool StructuredDataIHelperTest::TestCopyConstructor() {
    ConfigurationDatabase cdb;
    bool ok = cdb.CreateAbsolute("A");
    ok &= cdb.CreateAbsolute("A.B");
    ok &= cdb.CreateAbsolute("A.B.C");
...
bool StructuredDataIHelperTest::TestCopyOperatorEqual() {
...
bool StructuredDataIHelperTest::TestSetCurrentNodeAsRootNode() {
    ConfigurationDatabase cdb;
    bool ok = cdb.CreateAbsolute("A");
    ok &= cdb.CreateAbsolute("A.B");
    ok &= cdb.CreateAbsolute("A.B.C");
...
bool StructuredDataIHelperTest::TestPurge() {
    ConfigurationDatabase cdb;
    cdb.Purge();
    bool ok = true;
...
bool StructuredDataIHelperTest::TestCopyOperatorEqualBug() {
    ConfigurationDatabase cdb;
