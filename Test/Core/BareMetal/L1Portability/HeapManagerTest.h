...
#ifndef TEST_CORE_L1PORTABILITY_HeapManagerTest_H_
#define TEST_CORE_L1PORTABILITY_HeapManagerTest_H_
...
//    MARTe::StandardHeap sh;
    ...
    /**
     * @brief Test HeapManager::HeapIdFromName using an invalid name.
     * @return true if the id returned is standardHeapId
     */
