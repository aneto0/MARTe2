...
bool EndianityTest<T>::TestToBigEndian() {
    ...
    bool isBigEndian = Memory::Compare(&testValue, &valueBigEndian, sizeof(T));
...
bool EndianityTest<T>::TestToLittleEndian() {
    ...
    bool isLittleEndian = Memory::Compare(&testValue, &valueLittleEndian, sizeof(T));
...
bool EndianityTest<T>::TestMemCopyToBigEndian() {
    ...
    bool isBigEndian =  Memory::Compare(&testArray[0], &arrayBigEndian[0], 3 * sizeof(T));
...
bool EndianityTest<T>::TestMemCopyToLittleEndian() {
    ...
    bool isLittleEndian = Memory::Compare(&testArray[0], &arrayLittleEndian[0], 3 * sizeof(T));
...
bool EndianityTest<T>::TestMemCopyToFromEndian() {
    ...
    bool okLittleEndian = Memory::Compare(&testArray[0], &arrayToFrom[0], 3 * sizeof(T));
    ...
    //Each element should remain the same
    bool okBigEndian = Memory::Compare(&testArray[0], &arrayToFrom[0], 3 * sizeof(T));
