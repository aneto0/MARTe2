/**
 * @file VCPDescription.cpp
 * @brief Source file for class VCPDescription
 * @date 11/ago/2015
 * @author pc
 *
 ...
 * the class VCPDescription (public, protected, and private). Be aware that some 
...
/* Private variables ---------------------------------------------------------*/
USBD_DescriptorsTypeDef VCP_Desc = { USBD_VCP_DeviceDescriptor, USBD_VCP_LangIDStrDescriptor, USBD_VCP_ManufacturerStrDescriptor, USBD_VCP_ProductStrDescriptor,
