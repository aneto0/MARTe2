 ...
 */
void Threads::SetPriority(const ThreadIdentifier &threadId, const Threads::PriorityClassType &priorityClass, const uint8 &priorityLevel) {
...
bool Threads::IsAlive(const ThreadIdentifier &threadId) {
    Threads::ThreadStateType state = Threads::GetState(threadId);
...
#if USE_THREADS_DATABASE
ThreadIdentifier Threads::BeginThread(const ThreadFunctionType function, const void * const parameters, const uint32 &stacksize, const char8 * const name, const uint32 exceptionHandlerBehaviour, ProcessorType runOnCPUs) {
...
bool Threads::GetThreadInfoCopy(ThreadInformation &copy, const uint32 &n) {
#if USE_THREADS_DATABASE
...
bool Threads::GetThreadInfoCopy(ThreadInformation &copy, const ThreadIdentifier &threadId) {
#if USE_THREADS_DATABASE
