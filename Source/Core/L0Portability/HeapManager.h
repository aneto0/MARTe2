 ...
 * @details If \a size != 0 the function duplicates the size specified of the
 * memory area pointed by \data.
 * If \a size = 0 the function consider the memory area pointed by \a data as a zero
 ...
 * @pre If size = 0 the memory area pointed by \data must be a zero terminated string.
 */
