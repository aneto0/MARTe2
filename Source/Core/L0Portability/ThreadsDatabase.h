 ...
 * @param[in] ti contains the thread informations.
 ...
 *  @param[in] tid is the id of the thread to remove from database.
 ...
 * @param[out] tiCopy is a copy of the thread information structure in return.
 * @param[in] n is the index of the element in the database.
 * @param[in] tid is the identifier of the thread.
 * @return true if the requested thread is in the database.
 */
bool ThreadsDatabaseGetInfo(ThreadInformation &tiCopy,
                            int32 n,
                            TID tid);
...
public:
    ...
    friend bool ThreadsDatabaseGetInfo(ThreadInformation &tiCopy,
                                       int32 n,
                                       TID tid);
