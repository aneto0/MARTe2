/**
 * @file HighResolutionTime.h
 * @brief Header file for class HighResolutionTime
 * @date 17/06/2015
 ...
 * @details This header file contains the declaration of the class HighResolutionTime
