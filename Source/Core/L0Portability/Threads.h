...
/**
 * @brief Threads management class.
 *
 * @details These class allows to create, manage and monitor the life-cycle of any framework thread/
...
public:
     ...
     */
    static ThreadIdentifier BeginThread(const ThreadFunctionType function,
     ...
     */
    static bool Kill(const ThreadIdentifier &threadId);
     ...
     */
    static bool IsAlive(const ThreadIdentifier &threadId);
     ...
     */
    static const char8 *Name(const ThreadIdentifier &threadId);
     ...
     */
    static ThreadStateType GetState(const ThreadIdentifier &threadId);
     ...
     */
    static uint8 GetPriorityLevel(const ThreadIdentifier &threadId);
     ...
     */
    static PriorityClassType GetPriorityClass(const ThreadIdentifier &threadId);
     ...
     */
    static ThreadIdentifier FindByIndex(const uint32 &n);
     ...
     */
    static ThreadIdentifier FindByName(const char8 * const name);
