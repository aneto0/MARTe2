...
TimeStamp Directory::GetLastWriteTime() const {
...
TimeStamp Directory::GetLastAccessTime() const {
    //fill the time structure
    int32 secondsFromEpoch32 = static_cast<int32>(directoryHandle.st_atime);
