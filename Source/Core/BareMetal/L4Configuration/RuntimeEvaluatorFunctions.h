 ...
 */
/*lint -emacro( {446, 1502},  REGISTER_PCODE_FUNCTION ) Justification: Type2TypeDescriptor<>() is known to have no side-effects and can thus be used safely in ..._FunctionTypes[] array initialization.*/
