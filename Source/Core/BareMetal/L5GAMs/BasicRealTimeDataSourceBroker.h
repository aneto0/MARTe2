/**
 * @file BasicRealTimeDataSourceBroker.h
 * @brief Header file for class BasicRealTimeDataSourceBroker
 * @date 21/03/2016
 ...
 * @details This header file contains the declaration of the class BasicRealTimeDataSourceBroker
 * with all of its public, protected and private members. It may also include
 * definitions for inline methods which need to be visible to the compiler.
 */

#ifndef BASICREALTIMEDATASOURCEBROKER_H_
#define BASICREALTIMEDATASOURCEBROKER_H_
 ...
 */
class BasicRealTimeDataSourceBroker: public ReferenceContainer {
...
protected:
    ...
    FastPollingMutexSem *pollingSem;
...
#endif /* BASICREALTIMEDATASOURCEBROKER_H_ */
