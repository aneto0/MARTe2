/**
 * @file MemoryMapOutputWriter.h
 * @brief Header file for class MemoryMapOutputWriter
 * @date 11/04/2016
 ...
 * @details This header file contains the declaration of the class MemoryMapOutputWriter
 * with all of its public, protected and private members. It may also include
 * definitions for inline methods which need to be visible to the compiler.
 */

#ifndef MEMORYMAPOUTPUTWRITER_H_
#define MEMORYMAPOUTPUTWRITER_H_
...
#endif /* MEMORYMAPOUTPUTWRITER_H_ */
