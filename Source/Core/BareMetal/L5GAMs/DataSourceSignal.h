...
public:
    ...
    /**
     * @brief NOOP. @see DataSourceSignalI::WriteStart(*)
     */
    virtual void WriteStart();

    /**
     * @brief NOOP. DataSourceSignalI::ReadStart(*)
     */
    virtual void ReadStart();

    /**
     * @brief NOOP. DataSourceSignalI::WriteEnd(*)
     */
    virtual void WriteEnd();

    /**
     * @brief NOOP. DataSourceSignalI::ReadEnd(*)
     */
