...
/*---------------------------------------------------------------------------*/
namespace MARTe {
MemoryMapSynchronisedOutputBroker::MemoryMapSynchronisedOutputBroker() :
...
bool MemoryMapSynchronisedOutputBroker::Execute() {

    bool ret = MemoryMapOutputBroker::Execute();
    if (ret) {
...
CLASS_REGISTER(MemoryMapSynchronisedOutputBroker, "1.0")
}
