...
public:
    ...
    /**
     * @brief Converts the object to a StructuredDataI.
     * @param[out] data is the output structured data.
     * @return true if the object can be converted in \a data, false otherwise.
     */
