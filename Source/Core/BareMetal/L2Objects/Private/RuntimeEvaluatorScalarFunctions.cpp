/**
 * @file RuntimeEvaluatorScalarFunctions.cpp
...
#define REGISTER_CAST_FUNCTION(name,type1,type2,function)\
    ...
    static const RuntimeEvaluatorFunction name ## type1 ## type2 ## _FunctionRecord=RuntimeEvaluatorFunction(#name,1,1,name ## type1 ## type2 ## _FunctionTypes,&function<type1,type2>,NULLCheckMatrixSizesFun); \
