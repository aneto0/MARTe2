...
public:
     ...
     */
    DLL_API bool Insert(Reference ref,
     ...
     */
    DLL_API bool Delete(Reference ref);
     ...
     */
    DLL_API void Find(ReferenceContainer &result,
     ...
     */
    DLL_API bool IsContainer(const Reference &ref) const;
