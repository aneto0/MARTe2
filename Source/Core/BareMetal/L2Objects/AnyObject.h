...
/**
 *	@brief Creates an Object that contains the copy of the memory provided by the pointer up to the sizeToCopy specified.
...
#endif /* SOURCE_CORE_BAREMETAL_L2OBJECTS_ANYOBJECT_H_ */
