...
/*volatile CScheduler basicScheduler;
volatile CKernelOptions m_Options;
volatile CInterruptSystem interrupt;
volatile CTimer timer(&interrupt);
volatile CLogger m_Logger(m_Options.GetLogLevel(), &timer);
volatile CDeviceNameService m_DeviceNameService;
volatile CDWHCIDevice m_DWHCI(&interrupt, &timer);
*/
