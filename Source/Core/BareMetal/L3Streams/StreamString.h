 ...
 *  Construct as copy of char8 * or other BasicString
 *  Assign    as copy of char8 * or other BasicString
 *  Concatenate       a  char8 * or other BasicString
 *  Truncate to a given size
 *  Compare with      a  char8 *    
