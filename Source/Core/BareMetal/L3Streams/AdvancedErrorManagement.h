 ...
 * </pre>
 */
#define REPORT_ERROR_PROXY(...) EXPAND(REPORT_ERROR_PROXY_MACRO_CHOOSER(__VA_ARGS__, REPORT_ERROR_PROXY_PARAMETERS, REPORT_ERROR_PROXY_PARAMETERS, REPORT_ERROR_PROXY_PARAMETERS, REPORT_ERROR_PROXY_PARAMETERS, REPORT_ERROR_PROXY_PARAMETERS, REPORT_ERROR_PROXY_PARAMETERS, REPORT_ERROR_PROXY_PARAMETERS, REPORT_ERROR_PROXY_PARAMETERS, REPORT_ERROR_PROXY_PARAMETERS, REPORT_ERROR_PROXY_PARAMETERS, REPORT_ERROR_PROXY_0, REPORT_ERROR_PROXY_U)( __VA_ARGS__))
}
